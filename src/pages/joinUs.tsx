    ...
    {!isHome
      ...
      <div className="join-us__content">
        ...
        <div className="join-us__content__text">
          ...
          <a href="/" className="join-us__content__text__banner banner"><div className="banner__word banner__word--1">Join Now</div></a>
          <p>We also welcome (tax-deductable) donations.</p>
          <a href="/" className="join-us__content__text__banner banner"><div className="banner__word banner__word--2">Donate Now</div></a>
        </div>
      </div>
      <Footer />
    </div>
